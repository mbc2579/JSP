...
<body>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li class="active"><a href="Back.jsp">등운동</a></li>
	...
	<table border="0">	
		<tr>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/l264dpfJv70" 
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/E7TQPZCTYIs" 
				title="YouTube video player" frameborder="0" 
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
				</iframe>
			</td>
	...
	<table>
		<tr>
			...
			<td>
			<iframe width="560" height="315" src="https://www.youtube.com/embed/o_pwMN40DLM" 
			title="YouTube video player" frameborder="0" 
			allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
			</iframe>
			</td>
			...
			<td>
			<iframe width="560" height="315" src="https://www.youtube.com/embed/RHAKqVFvSzg" 
			title="YouTube video player" frameborder="0" 
			allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
			</iframe>
			</td>
