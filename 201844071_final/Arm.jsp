...
<body>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="Arm.jsp">팔운동</a></li>
	...
	<table border="0">	
		<tr>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/NqSfpsJn8M8" 
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/7738o4_uic8" 
				title="YouTube video player" frameborder="0" 
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
				</iframe>
			</td>
	...
	<table>
		<tr>
			...
			<td>
			<iframe width="560" height="315" src="https://www.youtube.com/embed/KTMeuLU3dII" 
			title="YouTube video player" frameborder="0" 
			allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
			</iframe>
			</td>
			...
			<td>
			<iframe width="560" height="315" src="https://www.youtube.com/embed/T-bVqdhqW2U" 
			title="YouTube video player" frameborder="0" 
			allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
			</iframe>
			</td>
