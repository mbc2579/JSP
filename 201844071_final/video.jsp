...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="video.jsp">동영상</a></li>
	...
	<table border="0">	
		<tr>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/eWyVzJOiQHM" 
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/Z8pfWXGcRzI" 
				title="YouTube video player" frameborder="0" 
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				allowfullscreen>
				</iframe>
	...
	<table>
		<tr>
			...
			<td>
			<iframe width="560" height="315" src="https://www.youtube.com/embed/vbNPXJKHe7I" 
			title="YouTube video player" frameborder="0" 
			allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
			allowfullscreen>
			</iframe>
			...
			<td>
			<iframe width="560" height="315" src="https://www.youtube.com/embed/Tuf5qKG5RwI" 
			title="YouTube video player" frameborder="0" 
			allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
			allowfullscreen>
			</iframe>
