		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="animal_protein.jsp">등운동</a></li>
						<li><a href="Vegetable_protein.jsp">어깨운동</a></li>
						<li><a href="Chicken_breast.jsp">가슴운동</a></li>
						<li><a href="Chicken_breast.jsp">팔운동</a></li>
						<li><a href="Chicken_breast.jsp">하체운동</a></li>
					</ul>
				</li>
			</ul>
				
				<li class="active"><a href="weight.jsp">헬스</a></li>
				<ul class="nav navbar-nav navbar">
				<li class="dropdown">
					<a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
