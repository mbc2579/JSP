...
<body>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="Lowerbody.jsp">하체운동</a></li>
					</ul>
				</li>
			</ul>
	...
	<table border="0">	
		<tr>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/tzN6ypk6Sps" 
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/KXYi6bI-UPE" 
				title="YouTube video player" frameborder="0" 
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
				</iframe>
			</td>
	...
	<table>
		<tr>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/dpBYYEhdofI" 
				title="YouTube video player" frameborder="0" 
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
				</iframe>
			</td>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/DWYDL-WxF1U" 
				title="YouTube video player" frameborder="0"
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
				</iframe>
			</td>
