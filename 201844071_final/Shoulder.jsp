...
<body>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="Shoulder.jsp">어깨운동</a></li>
	...
	<table border="0">	
		<tr>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/fr-5MKeRfVU" 
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/8COp_SJ64Ug" 
				title="YouTube video player" frameborder="0" 
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
				</iframe>
			</td>
	...
	<table>
		<tr>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/ucOQJDSVC2o" 
				title="YouTube video player" frameborder="0" 
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
				</iframe>
			</td>
			...
			<td>
				<iframe width="560" height="315" src="https://www.youtube.com/embed/cBZnbTeld2w" 
				title="YouTube video player" frameborder="0" 
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
				</iframe>
			</td>
